#
#  Be sure to run `pod spec lint ViewChaos.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "DuckDeck" => "3421902@qq.com" }
  # Or just: s.author    = "DuckDeck"
  # s.authors            = { "DuckDeck" => "3421902@qq.com" }
  # s.social_media_url   = "http://twitter.com/DuckDeck"
